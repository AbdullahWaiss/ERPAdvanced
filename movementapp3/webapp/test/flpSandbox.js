		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movement app 3",
									"targetURL": "#movementapp3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"movementapp3-display": {
								"semanticObject": "movementapp3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=movementapp3",
									"url": sap.ui.require.toUrl("movementapp3")
								}
							}
						}
					}
