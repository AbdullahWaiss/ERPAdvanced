sap.ui.define([
    ...
    return BaseController.extend("movementapp3.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "movementapp3.view.ViewSettingsDialog",
                    controller: this
        ...
        onAddMovementPress: function() {
            // Maak een nieuw Movement-object aan
            var oNewMovement = {
              Id: "NEW_ID", // Vervang NEW_ID door een unieke ID voor de nieuwe movement
              // Vul hier de overige eigenschappen van de nieuwe movement in
              Type: "",
              MovDate: new Date(),
              ChgDate: new Date(),
              ChgUser: "",
            ...
            // Voeg de nieuwe movement toe aan de modelgegevens
            var oModel = this.getView().getModel();
            var aMovements = oModel.getProperty("/MovementSet");
            aMovements.push(oNewMovement);
            oModel.setProperty("/MovementSet", aMovements);
          
            // Navigeer naar de detailweergave van de nieuwe movement
            this.getOwnerComponent().getRouter().navTo("detail", {
              movementId: oNewMovement.Id
            });
          }
